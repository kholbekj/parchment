...
```bash
npm install @drifting-ink/parchment
```

### CDN

```html
<script src="https://unpkg.com/@drifting-ink/parchment"></script>
<!-- or -->
<script src="https://cdn.jsdelivr.net/npm/@drifting-ink/parchment"></script>
```
